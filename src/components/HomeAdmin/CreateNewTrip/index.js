...
const [form, setForm] = useState ({
    ...
    function handleChange(e) {
      ...
      //   setForm({ ...form, [e.target.name.enum]: e.target.value });
      // }
...
style={{ marginBottom: 5 }}
      >
        <Input.TextArea showCount maxLength={300} autoSize={{ minRows: 3}}         name="description"
        label="Description"
        style={{ marginBottom: 5 }}
      ...
      <Form.Item label="Upload Image" htmlFor="formImg" style={{ marginBottom: 5 }} >
...
// type="file" id="formImg" onChange={handleImage}